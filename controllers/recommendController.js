...
// ============================================================
//  PROCODER AI PARSER — Zero API dependency
...
const ADJECTIVE_DICTIONARY = [
  ...
  { trait: "religious", tokens: [
    "religious", "spiritual", "loves quran", "loves mosque", "goes to mosque",
    "loves prayer", "memorizes quran", "hafiz", "islamic",
    "quran recitation", "quran memorization", "learning quran",
    "learn quran", "listening to quran", "start quran",
...
const INTEREST_KEYWORDS = {
  ...
  quran:        ["quran", "qur'an", "القران", "قران", "تجويد", "tajweed", "حفظ", "تلاوه", "hifz", "recitation", "memoriz"],
...
const GOAL_PATTERNS = [
  ...
  { goal: "memorize_quran", patterns: ["memorize quran", "hifz", "حفظ القران", "يحفظ قران", "تحفظ قران"] },
  { goal: "learn_quran", patterns: ["learn quran", "quran recit", "يتعلم القران", "تلاوه", "تجويد"] },
...
const TRAIT_COURSE_SCORES = {
  ...
  calm:             { python: 6, "algo-intro": 6, "quran-memorization": 7, "arabic-grammar": 6 },
  sedentary:        { python: 6, "quran-memorization": 5, webdev: 5 },
  shy:              { python: 8, "algo-intro": 7, "quran-memorization": 8, "arabic-reading": 7 },
  anxious:          { scratch: 8, "arabic-reading": 7, "quran-recitation": 7 },
  introverted:      { python: 8, "algo-intro": 7, "algo-competitive": 6, "quran-memorization": 7 },
  social:           { "robot-basics": 8, "robot-advanced": 7, gamedev: 7, "quran-recitation": 6 },
  ...
  sensitive:        { scratch: 7, "quran-recitation": 7, "arabic-reading": 6 },
  ...
  musical:          { "quran-recitation": 7, scratch: 4 },
  ...
  strong_memory:    { "quran-memorization": 10, "quran-recitation": 7, "algo-competitive": 5 },
  deep_thinker:     { "algo-intro": 8, "algo-competitive": 7, python: 7 },
  focused:          { "quran-memorization": 9, "algo-competitive": 8, "arabic-grammar": 7, webdev: 7 },
  patient:          { "quran-memorization": 9, "algo-competitive": 7, "arabic-grammar": 8 },
  detail_oriented:  { "algo-competitive": 8, webdev: 7, "arabic-grammar": 7 },
  struggling:       { scratch: 9, "quran-recitation": 6, "arabic-reading": 6 },
  needs_confidence: { scratch: 9, "quran-recitation": 7, "arabic-reading": 7 },
  average:          { scratch: 4, "robot-basics": 4, "quran-recitation": 4, "arabic-reading": 4 },
  ...
  religious:        { "quran-recitation": 10, "quran-memorization": 10, "arabic-reading": 7, "arabic-grammar": 6 },
  nature_oriented:  { "robot-basics": 5, python: 4 },
  visual_learner:   { scratch: 9, gamedev: 8, webdev: 7, "robot-basics": 5 },
  auditory_learner: { "quran-recitation": 9, "arabic-reading": 7 },
  kinesthetic_learner: { "robot-basics": 10, "robot-advanced": 8, scratch: 6 },
  impulsive: { scratch: 9, "robot-basics": 9, gamedev: 6, "quran-recitation": 4 },
  oppositional: { gamedev: 8, scratch: 8, "robot-basics": 6 },
  sensory_sensitive: { scratch: 8, "quran-recitation": 7, "arabic-reading": 7, python: 5 },
  sensory_seeking: { "robot-basics": 10, "robot-advanced": 8, scratch: 7 },
  transition_sensitive: { scratch: 8, "arabic-reading": 6, "quran-recitation": 6 },
...
const INTEREST_COURSE_MAP = {
  ...
  quran:       ["quran-recitation", "quran-memorization"],
...
function scoreCourses(profile, courses) {
  return courses.map((course) => {
    ...
    if (profile.learning_style === "auditory" && ["quran", "arabic"].includes(course.category)) score += 5;
    ...
    if (profile.energy_level === "low" && ["quran", "arabic", "algorithms"].includes(course.category)) score += 3;
    ...
    if (profile.special_needs) {
      ...
      if (profile.special_needs.includes("dyslexia")) {
        if (["scratch", "robot-basics", "quran-recitation"].includes(course.slug)) score += 6;
...
const TRAIT_EXPLANATIONS_AR = {
  ...
  musical: "أساليب التعلم الإيقاعية واللحنية تجعل دورات التلاوة جذابة بشكل خاص",
};
...
const COURSE_NAMES_EN = {
  ...
  "quran-recitation": "Quran Recitation", "quran-memorization": "Quran Memorization",
...
const COURSE_NAMES_AR = {
  ...
  "quran-recitation": "تلاوة القرآن", "quran-memorization": "حفظ القرآن",
